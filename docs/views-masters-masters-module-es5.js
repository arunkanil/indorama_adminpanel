      ...
      var mastersComponent = /*#__PURE__*/function () {
        ...
        _createClass(mastersComponent, [{
          ...
          value: function loadPrev() {
            ...
            this.from = this.from - this.pageSize;
            this.to = this.to - this.rowData.length; // this.dataservice
            //   .getFarmDemos(this.count, this.pageSize)
            //   .valueChanges.subscribe((result: any) => {
            //     this.meta = result.data.farmDemos.meta;
            //     this.rowData = result.data.farmDemos.data;
          ...
          value: function cropSubmit() {
            ...
            if (!this.disableButton) {
              this.dataservice.UpdateCrop(this.cropForm.value, this.selectedRows[0].id).subscribe(function (result) {
                resp = result.data;
                console.log("response", result);
              ...
              this.dataservice.AddCrop(this.cropForm.value).subscribe(function (result) {
                resp = result.data;
                console.log("response", result);
