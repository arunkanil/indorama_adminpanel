      ...
      var DashboardComponent = /*#__PURE__*/function () {
        ...
        _createClass(DashboardComponent, [{
          ...
          value: function getData() {
            ...
            this.getMarkets();
            this.dataservice.getDashboardStats().valueChanges.subscribe(function (result) {
          ...
          value: function getCropPrices(crop) {
            ...
            console.log(crop);
            this.dataservice.getCropPricesDashboard(crop === null || crop === void 0 ? void 0 : crop.id, (_a = this.selectedMarket) === null || _a === void 0 ? void 0 : _a.id).valueChanges.subscribe(function (result) {
          ...
          value: function getSoilTestStats(event) {
            ...
            this.dataservice.getDashboardStats(event.id).valueChanges.subscribe(function (result) {
              _this5.DashboardStats = result.data;
            });
            this.dataservice.getSoilTestStats(event.id).subscribe(function (result) {
              var _a;
          ...
          value: function getFarmDemoStatsDashboard(data) {
            ...
            this.dataservice.getFarmDemoStatsDashboard(data.id, "ONGOING").valueChanges.subscribe(function (result) {
              _this6.FarmDemoStats = result.data;
            });
            this.barChartData_farmdemo = [];
            this.dataservice.getFarmDemoYieldStats(data.id).subscribe(function (result) {
              var _a;
