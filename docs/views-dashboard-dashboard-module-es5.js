      ...
      var DashboardComponent = /*#__PURE__*/function () {
        ...
        _createClass(DashboardComponent, [{
          ...
          value: function getCropPrices(crop) {
            ...
            console.log(crop);
            this.dataservice.getCropPricesDashboard(crop === null || crop === void 0 ? void 0 : crop.id, (_a = this.selectedMarket) === null || _a === void 0 ? void 0 : _a.id, this.fromDate, this.toDate).valueChanges.subscribe(function (result) {
          ...
          value: function getFarmDemoStatsDashboard(data) {
            ...
            this.barChartData_farmdemo = [];
            this.dataservice.getFarmDemoYieldStats(data.id, this.fromDate, this.toDate).subscribe(function (result) {
              var _a;
