...
/* harmony import */ var _chat_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chat.component */ "l9bd");
...
/* harmony import */ var _chat_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chat-routing.module */ "tfKl");
...
ChatModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        ...
        declarations: [
            _chat_component__WEBPACK_IMPORTED_MODULE_4__["ChatComponent"],
        ]
    })
], ChatModule);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_chat_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./chat.component.html */ "ugap");
/* harmony import */ var _chat_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chat.component.css */ "/qiK");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "8Y7J");
...
/* harmony import */ var _chat_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chat.component */ "l9bd");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"animated fadeIn\">\r\n  <div class=\"card\">\r\n    <div class=\"card-header\" style=\"display: flex; justify-content: space-between\">\r\n      <h2>Chat Home</h2>\r\n      <div class=\"btn-group float-right\" dropdown>\r\n        <button dropdownToggle type=\"button\" class=\"btn btn-primary dropdown-toggle\">{{selectedList}}<span\r\n            class=\"caret\"></span></button>\r\n        <ul *dropdownMenu class=\"dropdown-menu\" role=\"menu\">\r\n          <li role=\"menuitem\">\r\n            <a class=\"dropdown-item\" (click)=\"toggleChat(false)\">All Chats</a>\r\n            <a class=\"dropdown-item\" (click)=\"toggleChat(true)\">Ask Indorama</a>\r\n          </li>\r\n        </ul>\r\n      </div>\r\n    </div>\r\n    <main class=\"content\">\r\n      <div class=\"container-fluid p-0\">\r\n\r\n        <!-- <h1 class=\"h3 mb-3\">Messages</h1> -->\r\n\r\n        <div class=\"card\">\r\n          <div class=\"row g-0\">\r\n            <div class=\"col-12 col-lg-5 col-xl-3 border-right\" style=\"max-height: 90vh; overflow-y:scroll;\">\r\n              <div class=\"px-4 d-none d-md-block\">\r\n                <div class=\"d-flex align-items-center\">\r\n                  <div class=\"flex-grow-1\">\r\n                    <input ngModel type=\"text\" class=\"form-control my-3\" (change)=\"onChange($event)\"\r\n                      placeholder=\"Search...\">\r\n                    <button class=\"btn btn-primary\" (click)=\"searchChats()\">Search</button>\r\n                    <button class=\"btn btn-secondary\" (click)=\"clearSearch()\">Clear</button>\r\n                  </div>\r\n                </div>\r\n              </div>\r\n              <a *ngFor=\"let item of chatData\" class=\"list-group-item list-group-item-action border-0\"\r\n                (click)=\"getChatMessages(item)\">\r\n                <!-- <div class=\"badge bg-success float-right\">5</div> -->\r\n                <div class=\"d-flex align-items-start\">\r\n                  <img *ngIf=\"item?.attributes?.chatInitiatedBy?.data?.attributes?.prof_pic.data?.attributes?.url\"\r\n                    src=\"https://indoramaapp.untanglestrategy.com{{item?.attributes?.chatInitiatedBy?.data?.attributes?.prof_pic?.data?.attributes?.url}}\"\r\n                    class=\"rounded-circle mr-1\" alt=\"profile pic\" width=\"40\" height=\"40\">\r\n                  <img *ngIf=\"!item?.attributes?.chatInitiatedBy?.data?.attributes?.prof_pic.data?.attributes?.url\"\r\n                    src=\"../../../assets/img/avatars/6.png\" class=\"rounded-circle mr-1\" alt=\"profile pic\" width=\"40\"\r\n                    height=\"40\">\r\n                  <div class=\"flex-grow-1 ml-3\">\r\n                    {{item?.attributes?.chatInitiatedBy?.data?.attributes?.Name}}\r\n                    <div class=\"small\">{{item?.attributes?.members?.data[1]?.attributes?.Name}} -\r\n                      {{item?.attributes?.members?.data[0]?.attributes?.Name}}</div>\r\n                  </div>\r\n                </div>\r\n              </a>\r\n              <button class=\"btn btn-primary\" (click)=\"loadMoreChats()\" style=\"float: right;\">Load more</button>\r\n\r\n              <hr class=\"d-block d-lg-none mt-1 mb-0\">\r\n            </div>\r\n            <div class=\"col-12 col-lg-7 col-xl-9\">\r\n              <div class=\"py-2 px-4 border-bottom d-none d-lg-block\">\r\n                <div class=\"d-flex align-items-center py-1\" style=\"justify-content: space-between;\">\r\n                  <div>\r\n                    <!-- <div class=\"position-relative\">\r\n                      <img src=\"https://bootdey.com/img/Content/avatar/avatar3.png\" class=\"rounded-circle mr-1\"\r\n                        alt=\"Sharon Lessman\" width=\"40\" height=\"40\">\r\n                    </div> -->\r\n                    <div class=\"flex-grow-1 pl-3\">\r\n                      <img *ngIf=\"chatMembers[0]?.attributes?.prof_pic.data?.attributes?.url\"\r\n                        src=\"https://indoramaapp.untanglestrategy.com{{chatMembers[0]?.attributes?.prof_pic.data?.attributes?.url}}\"\r\n                        class=\"rounded-circle mr-1\" alt=\"Sharon Lessman\" width=\"40\" height=\"40\">\r\n                      <img *ngIf=\"!chatMembers[0]?.attributes?.prof_pic.data?.attributes?.url\"\r\n                        src=\"../../../assets/img/avatars/6.png\" class=\"rounded-circle mr-1\" alt=\"profile pic\" width=\"40\"\r\n                        height=\"40\">\r\n                      <strong>{{chatMembers[0]?.attributes?.Name}}</strong>\r\n                      <!-- <div class=\"text-muted small\"><em>Typing...</em></div> -->\r\n                    </div>\r\n                  </div>\r\n                  <div>\r\n                    <!-- <div class=\"position-relative\">\r\n                      \r\n                    </div> -->\r\n                    <div class=\"flex-grow-1 pl-3\">\r\n                      <img *ngIf=\"chatMembers[1]?.attributes?.prof_pic.data?.attributes?.url\"\r\n                        src=\"https://indoramaapp.untanglestrategy.com{{chatMembers[1]?.attributes?.prof_pic.data?.attributes?.url}}\"\r\n                        class=\"rounded-circle mr-1\" alt=\"Sharon Lessman\" width=\"40\" height=\"40\">\r\n                      <img *ngIf=\"!chatMembers[1]?.attributes?.prof_pic.data?.attributes?.url\"\r\n                        src=\"../../../assets/img/avatars/6.png\" class=\"rounded-circle mr-1\" alt=\"profile pic\" width=\"40\"\r\n                        height=\"40\">\r\n                      <strong>{{chatMembers[1]?.attributes?.Name}}</strong>\r\n                      <!-- <div class=\"text-muted small\"><em>Typing...</em></div> -->\r\n                    </div>\r\n                    <!-- <button class=\"btn btn-primary btn-lg mr-1 px-3\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\"\r\n                        height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"\r\n                        stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"feather feather-phone feather-lg\">\r\n                        <path\r\n                          d=\"M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z\">\r\n                        </path>\r\n                      </svg></button>\r\n                    <button class=\"btn btn-info btn-lg mr-1 px-3 d-none d-md-inline-block\"><svg\r\n                        xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\"\r\n                        stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"\r\n                        class=\"feather feather-video feather-lg\">\r\n                        <polygon points=\"23 7 16 12 23 17 23 7\"></polygon>\r\n                        <rect x=\"1\" y=\"5\" width=\"15\" height=\"14\" rx=\"2\" ry=\"2\"></rect>\r\n                      </svg></button>\r\n                    <button class=\"btn btn-light border btn-lg px-3\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\"\r\n                        height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"\r\n                        stroke-linecap=\"round\" stroke-linejoin=\"round\"\r\n                        class=\"feather feather-more-horizontal feather-lg\">\r\n                        <circle cx=\"12\" cy=\"12\" r=\"1\"></circle>\r\n                        <circle cx=\"19\" cy=\"12\" r=\"1\"></circle>\r\n                        <circle cx=\"5\" cy=\"12\" r=\"1\"></circle>\r\n                      </svg></button> -->\r\n                  </div>\r\n                </div>\r\n              </div>\r\n\r\n              <div class=\"position-relative\">\r\n                <div class=\"chat-messages p-4\">\r\n                  <div *ngFor=\"let item of messageData?.attributes?.messages?.data\" class=\"chat-message-left pb-4\">\r\n                    <div>\r\n                      <img *ngIf=\"item?.attributes?.from_user?.data?.attributes?.prof_pic?.data?.attributes?.url\"\r\n                        src=\"https://indoramaapp.untanglestrategy.com{{item?.attributes?.from_user?.data?.attributes?.prof_pic?.data?.attributes?.url}}\"\r\n                        class=\"rounded-circle mr-1\" alt=\"Chris Wood\" width=\"40\" height=\"40\">\r\n                      <img *ngIf=\"!item?.attributes?.from_user?.data?.attributes?.prof_pic?.data?.attributes?.url\"\r\n                        src=\"../../../assets/img/avatars/6.png\" class=\"rounded-circle mr-1\" alt=\"Chris Wood\" width=\"40\"\r\n                        height=\"40\">\r\n                      <div class=\"text-muted small text-nowrap mt-2\">\r\n                        {{convertDate(item?.attributes?.createdAt)}}<br>{{convertTime(item?.attributes?.createdAt)}}\r\n                      </div>\r\n                    </div>\r\n                    <div class=\"flex-shrink-1 bg-light rounded py-2 px-3 mr-3\">\r\n                      <div class=\"font-weight-bold mb-1\">{{item?.attributes?.from_user?.data?.attributes?.Name}}</div>\r\n                      <img *ngIf=\"item?.attributes?.image_attachment?.data?.attributes?.url\"\r\n                        src=\"https://indoramaapp.untanglestrategy.com{{item?.attributes?.image_attachment?.data?.attributes?.url}}\"\r\n                        class=\"mr-1\" alt=\"Chris Wood\" width=\"100%\" height=\"100\">\r\n                      <div>{{item?.attributes?.message}}</div>\r\n                    </div>\r\n                  </div>\r\n                  <!-- <div class=\"chat-message-left pb-4\">\r\n                    <div>\r\n                      <img src=\"https://bootdey.com/img/Content/avatar/avatar3.png\" class=\"rounded-circle mr-1\"\r\n                        alt=\"Sharon Lessman\" width=\"40\" height=\"40\">\r\n                      <div class=\"text-muted small text-nowrap mt-2\">2:34 am</div>\r\n                    </div>\r\n                    <div class=\"flex-shrink-1 bg-light rounded py-2 px-3 ml-3\">\r\n                      <div class=\"font-weight-bold mb-1\">Sharon Lessman</div>\r\n                      Sit meis deleniti eu, pri vidit meliore docendi ut, an eum erat animal commodo.\r\n                    </div>\r\n                  </div> -->\r\n\r\n                </div>\r\n              </div>\r\n\r\n              <!-- <div class=\"flex-grow-0 py-3 px-4 border-top\">\r\n              <div class=\"input-group\">\r\n                <input type=\"text\" class=\"form-control\" placeholder=\"Type your message\">\r\n                <button class=\"btn btn-primary\">Send</button>\r\n              </div>\r\n            </div> -->\r\n\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </main>\r\n  </div>\r\n</div>");

/***/ })

}]);
//# sourceMappingURL=views-chat-chat-module-es2017.js.map